//
//  ReataurantListViewController.swift
//  LetsEat
//
//  Created by Ben Schwartz on 3/11/20.
    ...
    func createData() {
           ...
           manager.fetch(by: location, with: filter) { _ in
               if manager.numberOfItems() > 0 {
                   ...
                   view.set(title: "Hench")
                   view.set(desc: "No restaurants found. Man")
                   collectionView.backgroundView = view
               }
               collectionView.reloadData()
           }
    }
    func setupTitle() { // how is the navigation controller visible
